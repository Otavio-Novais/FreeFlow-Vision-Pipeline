...
class PlateOCR:
    ...
    def preprocess_image(self,image: np.ndarray) -> np.ndarray:
        ...
        if current_height < target_height:
            ...
            print(f"O atual current_height é {current_height}\n e a scale recomendada é: {scale:.2f}")
        else:
            scale = 1.0
    ...
    def correct_plate_by_pattern(self, text: str) -> str:
        ...
        rules_old = {0:'alpha', 1:'alpha', 2:'alpha', 3:'digit', 4:'digit', 5:'digit', 6:'digit'}
        rules_merc = {0:'alpha', 1:'alpha', 2:'alpha', 3:'digit', 4:'alpha', 5:'digit', 6:'digit'}
        ...
        if valid_old and not valid_merc: return valid_old
        if valid_merc and not valid_old: return valid_merc
